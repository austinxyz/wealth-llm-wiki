...
```bash
cd wealth
mv "个人现金与投资记录.md" output/
mv "个人退休基金记录.md" output/
mv "个人持仓快照.md" output/
mv "投资执行日志.md" output/
mv "投资优化分析.md" output/
mv "投资优化计划.md" output/
...
|-----------|--------------|----------------|
| 税务优化 / 税损收割 | wiki/税务策略/* | output/个人持仓快照.md, output/投资执行日志.md |
| Roth IRA / 退休账户 | wiki/账户类型/Roth-IRA.md, wiki/账户类型/401K.md | output/个人退休基金记录.md, output/个人退休基金策略文件.md |
| 退休规划 | wiki/退休规划/* | output/三段式退休规划.md, output/runway-calculation.md |
| 投资配置 / 持仓 | wiki/投资品种/*, wiki/账户类型/* | output/个人持仓快照.md, output/我的个人投资策略.md |
| 现金管理 / SGOV | wiki/账户类型/SGOV.md | output/个人现金与投资记录.md |
| IUL / 保险 | wiki/投资品种/IUL.md | output/IUL分析报告.md |
| 中美 / 双边 | wiki/中美对比/* | output/个人现金与投资记录.md |
